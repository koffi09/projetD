    ...
    <section id="presentation">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="element">
                          <h1 style="text-align:center; color:#d0bc00 ; background-color: black;margin-top:80px" > <b>PARFUMS HOMMES</b>
                          </h1>
                        </div>
                    </div>
                </div>
...
<?php  $produit = $BD->query("SELECT*FROM produits WHERE categories='homme'");?>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                <div class="product-image">
                    ...
                    <ul class="social">
                        <li> <a href="" class=" addpanier" data-tip="Ajouter au panier"><i class="fa fa-shopping-cart"></i></a></li>
                    </ul>
                ...
                <div class="product-content">
                    ...
                    <div class="price"><?= number_format($produits->prixProduit,2,',','');?>
                        <span><?= number_format($produits->prixProduit,2,',','');?></span>
                    </div>
