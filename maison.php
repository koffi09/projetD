    ...
    <section id="presentation">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="element">
                          <h1 style="text-align:center; color:#d0bc00 ; background-color: black;margin-top:80px" > <b>PARFUMS POUR MAISON</b>
                          </h1>
                        </div>
                    </div>
                </div>
...
<?php  $produit = $BD->query("SELECT*FROM produits WHERE categories='maison'");?>
            ...
            <div class="product-grid">
                ...
                <div class="product-content">
                    ...
                    <div class="price"><?= number_format($produits->prixProduit,2,',','');?>FCFA
                        <span><?= number_format($produits->prixProduit,2,',','');?>FCFA</span>
                    </div>
